  ...
  handler: async (ctx) => {
    ...
    const skills = [
      ...
      },
      {
        ...
        longDescription: "Extract clean, structured data from any website — even those behind Cloudflare, Akamai, or custom anti-bot protections. Returns clean HTML, text, metadata, links, and images.",
        category: "Data",
        ...
        exampleInput: '{ "url": "https://example.com/products", "selector": ".product-card" }',
        exampleOutput: '{ "items": [{ "title": "Widget Pro", "price": "$29.99" }], "totalFound": 24 }',
        responseTime: "~3.5s",
      },
      {
        ...
        longDescription: "Produce publish-ready blog posts optimized for search engines. Provide a topic and target keywords — get back a full article with title, meta description, headers, and readability score.",
        category: "Content",
        ...
        exampleInput: '{ "topic": "Best CRM for small business", "keywords": ["crm software"], "wordCount": 1500 }',
        exampleOutput: '{ "title": "10 Best CRM Solutions...", "wordCount": 1520, "readabilityScore": 72 }',
        responseTime: "~8.0s",
      },
      {
        ...
        longDescription: "Create high-quality images from natural language descriptions. Supports various styles (photorealistic, illustration, 3D, anime) and aspect ratios.",
        category: "Vision",
        ...
        exampleInput: '{ "prompt": "A modern minimalist logo", "style": "flat-design", "size": "1024x1024" }',
        exampleOutput: '{ "imageUrl": "https://...", "style": "flat-design", "dimensions": "1024x1024" }',
        responseTime: "~6.0s",
      },
      {
        ...
        longDescription: "Comprehensive email validation: syntax check, MX record lookup, disposable domain detection, role-based address detection, and deliverability scoring. Bulk-capable.",
        category: "Data",
